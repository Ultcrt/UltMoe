...
contextBridge.exposeInMainWorld("electronAPI", {
    ...
    addTorrent: (id, torrentId, isRestore, fromSubscription, downloadPath, pageUrl) => ipcRenderer.send("mainWindow:addTorrent", id, torrentId, isRestore, fromSubscription, downloadPath, pageUrl),
